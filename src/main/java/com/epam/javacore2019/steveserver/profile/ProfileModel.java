package com.epam.javacore2019.steveserver.profile;
...
public class ProfileModel {
    ...
    public ProfileModel(int id, String firstName, String lastName, String nickname, int criminalFamilyId, Date birthday, boolean deceased, Date dateOfDeath, int numberOfCrimes) {
        this.id = id;
    ...
    public ProfileModel setBirthday(Date birthday) {
        this.birthday = birthday;
        return this;
    }
